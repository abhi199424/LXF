...
{if $product.show_price}
  ...
  {if $product.has_discount}
    ...
    {block name='product_price'}
      <div
        class="product-price h5 price_sec {if $product.has_discount}has-discount{/if}">

        <div class="current-price offer_price">
        ...
        {if $product.has_discount}
          <div class="product-discount actual_price">
    ...
    {if $product.add_to_cart_url}
        <div class="instock"><img src="{$urls.child_img_url}dot.png" alt="instock"> Disponible</div>
    {else}
      <div class="outofstock"><img src="{$urls.child_img_url}red-cross.png" alt="outstock"> Rupture de stock</div>
    {/if}
  </div>*}
  </div>
{/if}
