...
<div class='statistics'>
	...
	<table class='general'>
		<tr class='title'>
			...
			<td>{l s='Number of products reviews' mod='allinone_rewards'}</td>
			<td>{l s='Number of site reviews' mod='allinone_rewards'}</td>
			<td>{l s='Total reviews' mod='allinone_rewards'}</td>
			<td class='price'>{l s='Rewards for products reviews' mod='allinone_rewards'}</td>
			<td class='price'>{l s='Rewards for site reviews' mod='allinone_rewards'}</td>
			<td class='price'>{l s='Total rewards' mod='allinone_rewards'}</td>
		</tr>
		<tr>
			<td>{$stats['nb_customers']|intval}</td>
			<td>{$stats['nb_products_reviews']|intval}</td>
			<td>{$stats['nb_site_reviews']|intval}</td>
			<td>{$stats['nb_total_reviews']|intval}</td>
			<td class='price'>{displayPrice price=($stats['total_products_rewards']|floatval)}</td>
			<td class='price'>{displayPrice price=($stats['total_site_rewards']|floatval)}</td>
	...
	<table class='tablesorter tablesorter-ice'>
		<thead>
			<tr>
				...
				<th>{l s='Number of products reviews' mod='allinone_rewards'}</th>
				<th>{l s='Number of site reviews' mod='allinone_rewards'}</th>
				<th class='price'>{l s='Rewards for products reviews' mod='allinone_rewards'}</th>
				<th class='price'>{l s='Rewards for site reviews' mod='allinone_rewards'}</th>
			</tr>
		</thead>
		<tbody>
{if isset($stats['customers'])}
	{foreach from=$stats['customers'] item=customer}
			<tr>
				...
				<td class='center'>{$customer['nb_products_reviews']|intval}</td>
				<td class='center'>{$customer['nb_site_reviews']|intval}</td>
				<td class='right'>{displayPrice price=($customer['total_products_rewards']|floatval)}</td>
				<td class='right'>{displayPrice price=($customer['total_site_rewards']|floatval)}</td>
			</tr>
	{/foreach}
{/if}
		</tbody>
