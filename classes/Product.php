...
class ProductCore extends ObjectModel
{
    ...
    public static function getFirstAttributeImageId($id_product_attribute)
    {
        $image_ids = Product::_getAttributeImageAssociationsLt($id_product_attribute);
        return !empty($image_ids) ? reset($image_ids) : null;
    }

    public static function _getAttributeImageAssociationsLt($id_product_attribute)
    {
        $combination_images = [];
        $data = Db::getInstance()->executeS('
            SELECT pai.`id_image`
